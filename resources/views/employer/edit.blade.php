...
<body class="bg-gray-50 text-gray-800 p-8">
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <h1 class="text-xl font-bold text-gray-700 mb-6">Edit Employer</h1>

        <form method="POST" action="{{ route('employer.update', $employer->id) }}" class="space-y-5">
            @csrf
            @method('PUT') 
            ...
            <div class="pt-2 flex items-center gap-3">
                ...
                <a href="{{ route('employer.index') }}" class="text-sm text-gray-600 hover:text-gray-900 font-medium">
                    Cancel
                </a>
            </div>
        </form>
